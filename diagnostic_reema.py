...
def f06(string1, string2):
    if len(string1) > len(string2):
        ...
        print "'string1' is longer than 'string2' by {0} chars" .format(x)
        y = float(len(string2))/float(len(string1)) * 100
        print "'string2' has only {0}% the number of chars of 'string1'".format(y)
    else: 
        x = len(string2) - len(string1)
        print "'string2' is longer than 'string1' by {0} chars" .format(x)
        y =    float(len(string1))/float(len(string2))  * 100
        print "'string1' has only {0}% the number of chars of 'string2s'".format(y)
...
def f09():
    ...
    list_ = [x for x in range(1,500) if (x % 3 == 0) or (x % 5 == 0)]
    sum_ = sum(list_)
